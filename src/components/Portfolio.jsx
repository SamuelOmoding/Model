...
// ── The six portfolio sections, in display order ──
const SECTION_ORDER = [
  'Commercial',
  'Lifestyle',
  'Fashion',
...
// `section` = which of the 6 categories this photo belongs to (drives grouping)
// `category` = original descriptive label (still shown in the hover overlay)
const PHOTOS = [
  { id: 17, src: j2,      label: 'Casual',               category: 'Energy',              section: 'Lifestyle',           featured: false },
  { id: 1,  src: photo1,  label: 'Featured',              category: 'Editorial',           section: 'Editorial',           featured: true  },
  { id: 2,  src: photo2,  label: 'Lifestyle',              category: 'Lifestyle',           section: 'Lifestyle',           featured: false },
  { id: 3,  src: photo3,  label: 'Fashion',                category: 'Fashion',             section: 'Fashion',             featured: false },
  { id: 4,  src: photo4,  label: 'Commercial',             category: 'Commercial',          section: 'Commercial',          featured: false },
  { id: 5,  src: photo5,  label: 'Corporate',              category: 'Corporate Branding',  section: 'Corporate Branding',  featured: false },
  { id: 6,  src: photo8,  label: 'Tourism',                category: 'Tourism Campaign',    section: 'Tourism Campaign',    featured: false },
  { id: 7,  src: photo6,  label: 'Studio',                 category: 'Studio',              section: 'Fashion',             featured: false },
  { id: 8,  src: photo7,  label: 'Fitness',                category: 'Fitness',             section: 'Commercial',          featured: false },
  { id: 9,  src: photo9,  label: 'Portrait',               category: 'Portrait',            section: 'Editorial',           featured: false },
  { id: 10, src: photo10, label: 'Brand',                  category: 'Brand',               section: 'Corporate Branding',  featured: false },
  { id: 11, src: photo11, label: 'Night Shot',             category: 'NS',                  section: 'Editorial',           featured: false },
  { id: 12, src: c1,      label: 'Fitness',                category: 'Brand',               section: 'Commercial',          featured: false },
  { id: 14, src: f1,      label: 'Urban Jungle',           category: 'Street',              section: 'Lifestyle',           featured: false },
  { id: 15, src: g1,      label: 'GYM',                    category: 'Bodybuilding',         section: 'Commercial',          featured: false },
  { id: 16, src: j1,      label: 'Street Style',           category: 'Product',             section: 'Fashion',             featured: false },
  { id: 18, src: j3,      label: 'Brand',                  category: 'Jooz fuels hustle',    section: 'Commercial',          featured: false },
  { id: 19, src: l1,      label: 'Business Meeting',       category: 'Corporate',            section: 'Corporate Branding',  featured: false },
  { id: 20, src: l2,      label: 'Professional Portrait',  category: 'Corporate',            section: 'Corporate Branding',  featured: false },
  { id: 21, src: s1,      label: 'Performance',            category: 'Clear Vision',         section: 'Commercial',          featured: false },
  { id: 22, src: s2,      label: 'Action Shot',            category: 'Gaming',               section: 'Commercial',          featured: false },
  { id: 23, src: s3,      label: 'Sports',                 category: 'Athlete Lifestyle',    section: 'Lifestyle',           featured: false },
  { id: 24, src: s4,      label: 'Shades on',              category: 'Sports-Eye-wear',      section: 'Commercial',          featured: false },
]
...
export default function Portfolio() {
  ...
  // Group photos by section, preserving SECTION_ORDER, skipping empty sections
    ...
    <>
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .portfolio-grid      { grid-template-columns: repeat(2, 1fr); gap: 6px; }
          .portfolio-item-featured { grid-column: span 2; max-height: 320px; }
          .category-heading    { padding: 0 24px; }
          .marquee-divider     { margin: 40px 24px 28px; }
          .marquee-card        { width: 160px; height: 220px; }
        }
      ...
      <section className="portfolio-section" id="portfolio">
        ...
        {sections.map(({ name, photos }) => (
          <div className="category-block" key={name}>
            <div className="category-heading">
              <span className="category-heading-text">{name}</span>
              <div className="category-heading-line" />
              <span className="category-heading-count">
